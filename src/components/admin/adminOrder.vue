                        ...
                        <div class="addorder-form-infor-customer">
                            ...
                            <div class="row mt-2">
                                <div class="col-5">
                                    ...
                                    <div class="form-infor-customer-input">
                                        <label for="">Email<span class="span-requied">*</span></label>
                                        <input type="email" v-model="orderByIdUpdate.customerId.email" required>
                                    </div>
                                    <div class="form-infor-customer-input">
                                        <label for="">Địa chỉ<span class="span-requied">*</span></label>
                                        <input type="text" v-model="orderByIdUpdate.customerId.address" required>
                                    </div>
                                </div>
                                <div class="col form-customer-note">
                                    <label for="">Ghi chú:</label>
        ...
        async exportPdf() {
            ...
            this.orders.forEach((order, index) => {
                ...
                order.products.forEach(e => {
                    forTable += `
                    <tr>
                        <td style="border: 1px solid black; padding: 5px">${e.prodcutType}</td>
                        <td style="border: 1px solid black; padding: 5px">${e.productId.name}</td>
                        <td style="border: 1px solid black; padding: 5px; text-align: right;">${e.productId.saleQuantity}</td>
                        <td style="border: 1px solid black; padding: 5px; text-align: right;">${this.formatCurrency(e.productId.salePrice)}</td>
                    </tr>
                    `
                })
                table +=

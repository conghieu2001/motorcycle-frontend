<template>
    <div class="addorder-page-wrapper">
        ...
        <div class="addorder-page-content mt-0">
            ...
            <form action="" @submit.prevent="createOrder">
                    ...
                    <div class="row mt-2">
                        <div class="col-5">
                            ...
                            <div class="form-infor-customer-input">
                                ...
                                <input type="email" v-model="dataCreateOrder.email" placeholder="Nhập email" required>
                            </div>
                            <div class="form-infor-customer-input">
                                <label for="">Địa chỉ<span class="span-requied">*</span></label>
                                <input type="text" v-model="dataCreateOrder.address" placeholder="Nhập địa chỉ" required>
                            </div>
                        </div>
                ...
                <div class="m-3" v-for="(div, index) in dataCreateOrder.ListProducts" :key="index">
                    <div class="addorder-form-products row">
                        ...
                        <div class="col-3 d-grid">
                            ...
                            <input type="number" v-model="div.saleQuantity"  @input="checkSaleQuantity(index,div.saleQuantity)" placeholder="0" required>
                        </div>
                            <div class="error-checkquantity" v-if="!!div.mesMaxQuantity"><div style="width: 265px;">{{ div.mesMaxQuantity }}</div></div>
                    </div>
                </div>
                ...
                <div class="m-3 form-paymethods">
                    ...
                    <div class="metods-pay">
                        ...
                        <div class="pay-momo">
                            <input type="radio" name="paymethod" value="paypal" v-model="dataCreateOrder.methodPay" required>
